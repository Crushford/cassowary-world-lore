# Folder Summary: reference/predators

Generated summary bundle for documents in `reference/predators`.

## Documents

| Title                                                                        | Time Periods | Summary                                                                                                                  |
| ---------------------------------------------------------------------------- | ------------ | ------------------------------------------------------------------------------------------------------------------------ |
| [Haast's Eagle](../../../reference/predators/haasts-eagle.md)                |              | Real-world baseline for Haast's eagle as the top aerial predator of New Zealand and the primary predation pressure on... |
| [Sahul Predator Roles](../../../reference/predators/sahul-predator-roles.md) |              | Real-world baseline for the ecological roles filled by Sahul's predator guild and the mechanisms through which predat... |
