# Topic Summary: First Basin Civilisation

Generated summary bundle for docs tagged with `First Basin Civilisation`.

## Documents

| Title                                                                                                    | Path                                                | Layer     | Time Periods               | Summary                                                                                                                  |
| -------------------------------------------------------------------------------------------------------- | --------------------------------------------------- | --------- | -------------------------- | ------------------------------------------------------------------------------------------------------------------------ |
| [First Basin Civilisation](../../../lore/frameworks/first-basin-civilisation.md)                         | lore/frameworks/first-basin-civilisation.md         | Lore      | Kati Thunda Ant Revolution | The First Basin Civilisation is the first large-scale cassowary state society. It is the state-level expression of th... |
