...
| ---------------------------------------------------------------------------------- | ----------------------------------------------- | ----------- | ------------------------------------------------------------------------------------------------------------------------ |
| [Cassowary Wing-Claws ~12 MYA](../lore/divergences/cassowary-wing-claws-12-mya.md) | lore/divergences/cassowary-wing-claws-12-mya.md | Divergences | This divergence file tracks the root change in cassowary wing-claw function. Around `~12 MYA`, rising predator pressu... |

### Key Atomic Notes

- Cassowary Wing-Claws ~12 MYA: Cassowary wing-claw divergence begins as stronger chick wing-claw function under predator pressure around `~12 MYA`.
- Cassowary Wing-Claws ~12 MYA: The divergence changes the developmental importance of vestigial wing claws without granting sudden human-like hands.
- Cassowary Wing-Claws ~12 MYA: Later manipulation, tool use, carrying, craft, storage, transport, and institutions must trace back to this anatomical bridge.

## ~6-4 MYA

| Title                                                                                                     | Path                                                         | Layer | Summary                                                                                                                  |
| --------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------ | ----- | ------------------------------------------------------------------------------------------------------------------------ |
| [Aphid Stabilization](../lore/ecology/aphid-stabilization.md)                                             | lore/ecology/aphid-stabilization.md                          | Lore  | This document answers how cassowaries keep aphid-host relationships productive enough to sustain predictable honeydew... |
...
- Aphid Stabilization: Aphid stabilization is deliberate ecological management of host-tree and aphid relationships, not a new biological invention.
- Aphid Stabilization: Cassowaries increase honeydew reliability by keeping productive aphid populations within the range that host trees can sustain.
- Aphid Stabilization: The management target is stable flow, not maximal aphid abundance.
...
- Aphid Stabilization: Aphid overgrowth can damage host trees and reduce long-term orchard productivity.
- Aphid Stabilization: Predator and parasite pressure can destabilize managed aphid populations.
...
- Honeypot Ant Orchard System Management: Honeypot ant orchard management turns orchard trees, aphids, and ant reserves into a linked surplus system rather than a simple harvest of wild colonies.
- Honeypot Ant Orchard System Management: Cassowary intervention stabilizes host trees, aphid populations, nest conditions, and harvest intensity as one production chain.
- Honeypot Ant Orchard System Management: The system develops from opportunistic consumption in `~6-4 MYA`, repeated harvesting in `4-3 MYA`, early domestication in `~3-2.5 MYA`, and regional civilizational dependence in `~2.5-2 MYA`.
- Honeypot Ant Orchard System Management: Adoption remains uneven across Sahul because ecological variation, climate, and species distributions constrain where orchard-ant systems can persist.
- Honeypot Ant Orchard System Management: Long-term orchard stability is a prerequisite for reliable honeypot ant output.
- Honeypot Ant Orchard System Management: Host-tree decline, aphid loss, or climate stress can cascade into lower honeydew flow and reduced ant reserves.
...
- Orchard Lineage Management: Lineage management lets the civilization preserve roles such as calorie base, buffer fruit, and host trees even when species differ by region.
- Orchard Lineage Management: Orchard continuity is a prerequisite for stable aphid management and downstream honeypot-ant systems.
...
- Cassowary Neurodevelopment and Predator Management Transition: The `4-3 MYA` transition window lengthens juvenile dependence and increases the civilizational value of apprenticeship.
...
- Honeypot Ant Harvesting: Artificial chambers encourage nest expansion when they provide stable, protected, dry volume.
...
- Honeypot Ant Harvesting: In `4-3 MYA`, regional pottery-assisted proto-domestication shifts from opportunistic vessel placement toward intentional biasing of nest architecture.
...
- Honeypot Ant Harvesting: Sustainable harvest removes only part of a colony's reserve capacity while preserving seasonal recovery.
- Honeypot Ant Harvesting: Harvest methods may remove accessible repletes or vessel-contained storage clusters, then replace prepared chambers to encourage reoccupation.
...
- Honeypot Ant Harvesting: Overharvest and political extraction pressure can reduce colony resilience or cause local collapse.
- Honeypot Ant Orchard System Management: Honeypot ant orchard management turns orchard trees, aphids, and ant reserves into a linked surplus system rather than a simple harvest of wild colonies.
- Honeypot Ant Orchard System Management: Cassowary intervention stabilizes host trees, aphid populations, nest conditions, and harvest intensity as one production chain.
- Honeypot Ant Orchard System Management: The system develops from opportunistic consumption in `~6-4 MYA`, repeated harvesting in `4-3 MYA`, early domestication in `~3-2.5 MYA`, and regional civilizational dependence in `~2.5-2 MYA`.
- Honeypot Ant Orchard System Management: Adoption remains uneven across Sahul because ecological variation, climate, and species distributions constrain where orchard-ant systems can persist.
...
- Honeypot Ant Sugar Preservation: Preserved sugar production becomes possible at larger scale during `4-3 MYA`, becomes regular stored calories in `~3-2.5 MYA`, and becomes a major tribute, ration, and trade medium in some regions in `~2.5-2 MYA`.
...
- Honeypot Ant Nest Splitting: The divergence gives managed ant production a scalable propagation path by `~3-2.5 MYA`.
...
- Moa Mounted Warfare: The biological or breeding mechanism that makes moas rideable remains unresolved and is tracked separately as an open question.
- Orchard Lineage Management: Orchard lineage management preserves productive tree lineages instead of treating orchards as disposable annual plots.
- Orchard Lineage Management: Cassowaries maintain functional orchard roles by selecting, propagating, replacing, and regionally substituting tree lineages over generations.
- Orchard Lineage Management: Long maturation cycles make orchard planning slow, cumulative, and dependent on social continuity.
- Orchard Lineage Management: Regional climate and soil conditions limit which lineages can be transferred without losing function.
...
| Title                                                                                     | Path                          | Layer     | Summary                                                                                                                 |
| ----------------------------------------------------------------------------------------- | ----------------------------- | --------- | ----------------------------------------------------------------------------------------------------------------------- |
| [World State — ~2 MYA (Representative Glacial Maximum)](../reference/world-state-2mya.md) | reference/world-state-2mya.md | Reference | This file describes the baseline Earth context for the main Cassowary World setting around `~2 MYA`. It represents a... |
...
- Tribute Sealed Vessel Units: Proto-tribute through repeated seasonal vessel contributions appears in `~3.2-2.8 MYA`.
- Tribute Sealed Vessel Units: Standardized sealed vessel tribute appears in some core regions in `~2.7-2.3 MYA`.
...
- Tribute Storage Custody and Redistribution: Regional guarded storage centers and forwarded taxation networks emerge in `~2.2-1.8 MYA`.
