...
Real-world baseline for the climate and geography mechanisms that shaped Sahul across Pleistocene glacial cycles. Defines the mechanisms behind the world-state snapshot; the canonical setting baseline is [World State — Protohistoric Expansion Era](../world-state-protohistoric-expansion-era.md).
...
- Long-distance movement follows predictable corridors — uplands, river systems, coastlines, exposed shelves — not open uniform terrain.
