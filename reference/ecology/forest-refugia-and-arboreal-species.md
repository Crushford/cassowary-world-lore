...
- During glacial maxima, global temperature dropped 4–8°C and rainfall patterns shifted. In Sahul, this caused rainforest and wet tropical vegetation to contract from broad lowland distributions to smaller, isolated patches in reliably wet locations called refugia.
...
- Arboreal species — including tree kangaroos (*Dendrolagus* species — arboreal macropods that re-evolved climbing capability), cuscus (*Phalanger*, *Spilocuscus* — arboreal phalangerids dependent on closed canopy), and ringtail possums — were similarly confined to refugia during glacial maxima.
...
- Refugia that were stable across multiple glacial cycles — not only the most recent — represent true long-term anchors for forest-dependent populations.
