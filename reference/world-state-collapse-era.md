...
- Primary topic: World State — Collapse Era
...
- Regions: Sahul — road-dependent and haulage-dependent regional centres, contrasted with coastal, riverine, and locally resilient zones
...
- Uneven collapse is the rule. Coastal and riverine regions with access to alternative transport remain more functional. Arid interior zones, already marginal, may not collapse in the same dramatic way — they simply remain at lower institutional thresholds throughout.
...
Road surfaces do not disappear during the Collapse Era. Physical infrastructure — graded surfaces, drainage works, stone footings — often outlasts the political and logistical systems that maintained them.
...
This matters for the post-collapse period. The roads are still there. Some stretches remain usable. The political and economic task of the Logistics Stabilisation Era is not to rebuild from nothing — it is to reconnect and re-anchor existing physical infrastructure to new institutional arrangements that are more resilient to the failure modes now understood.
