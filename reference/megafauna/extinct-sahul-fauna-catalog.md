...
### Tier 1 — Near-2 MYA confirmed or well-supported

Taxa where the lineage or genus has documented presence in the relevant early Pleistocene window.

**Diprotodontid lineage** (diprotodontid-grade megaherbivores — the family Diprotodontidae persisted through this window)
...
**Zygomaturine lineage** (zygomaturines — semi-aquatic marsupial browsers within the diprotodontid family)
- Body mass range: 200–700 kg.
...
**Palorchestid lineage** (palorchestids — large clawed marsupial browsers; lineage from Miocene through Pleistocene)
...
- Constraint: clawed manipulation of woody plants creates a distinct disturbance type — physical tearing and pulling — different from bite-browsing by diprotodontids.

**Thylacine** (*Thylacinus cynocephalus* — thylacine, a pursuit mesopredator with wolf-like body form; confirmed from ~4 MYA onward)
- Body mass: estimated 15–30 kg.
...
**Dromornithid lineage** (dromornithids — giant flightless birds; the lineage was present in Sahul through this period)
- Body mass range: 100–500+ kg across the lineage.
- Ecology: herbivorous or omnivorous; large bill suited to processing tough plant material, seeds, or fruit. Not a predator. See [Dromornithidae](dromornithidae.md) for full lineage context.
- Constraint: imposed sustained vegetation pressure as large-bodied ground birds. Which genus is most appropriate for the ~2 MYA window remains unresolved; see [Dromornithidae](dromornithidae.md) open questions.

**Zaglossus** species (giant long-beaked echidna — confirmed in New Guinea and formerly Australia through Pleistocene)
- Body mass: estimated 5–15 kg depending on species (substantially larger than modern echidnas).
...
### Tier 2 — Lineage-level constraint secure; named species assignment uncertain
...
**Thylacoleonid lineage** (marsupial lion-grade predators — the family Thylacoleonidae; large-bodied ambush predator role in woodland and forest margins)
...
**Large varanid predator** (giant monitor lizard lineage — very large-bodied varanids were present in early Pleistocene Sahul)
...
**Large semi-terrestrial crocodilian** (Quinkana lineage — longer-legged semi-terrestrial crocodilians; genus represented in Pliocene–early Pleistocene Sahul)
...
### Tier 3 — Later-Pleistocene named species (valid analogues, not confirmed at ~2 MYA)
...
**Diprotodon optatum** (Diprotodon — the largest known marsupial; earliest confirmed fossils ~1.6 MYA)
- Body mass: estimated 1,000–2,800 kg.
...
**Thylacoleo carnifex** (marsupial lion — earliest confirmed fossils ~1.6–2 MYA)
- Body mass: estimated 100–160 kg.
...
### Tier 4 — Excluded from ~2 MYA window
...
- [Dromornithidae](dromornithidae.md)
