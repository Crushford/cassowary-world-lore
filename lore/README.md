...
This folder contains the retrievable Cassowary World knowledge layer.

Lore docs explain what emerges from real-world baseline conditions plus fundamental divergences. They should stay focused, metadata-friendly, and linked to relevant reference, divergence, and neighboring system docs.
