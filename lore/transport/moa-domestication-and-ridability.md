...
This document explains how moa domestication develops in New Zealand and how ridability emerges from generations of managed breeding, handling, and selection. It grounds the canon claim in [Moa Mounted Warfare](moa-mounted-warfare.md) in a plausible mechanism without overstating moa capabilities or treating ridability as an unexplained universal trait.
...
This document provides the mechanism that [Moa Mounted Warfare](moa-mounted-warfare.md) previously left unresolved. It does not change or demote the canon status of that document. The canon claim — that the northern empire imports moas from New Zealand and uses them for transport and warfare — stands. This document explains how the New Zealand moa system that makes that import possible came to exist.

The pathway is: fire incubation → egg capture and chick rearing → imprinting → captive breeding → gradual ridability development → harness design → export to Sahul via maritime contact. New Zealand moa handlers may inherit the general large-bird toolkit from Sahul, but they still need local generations of selection to adapt that toolkit to moa biology, New Zealand predator pressure, terrain, and available browse.
...
- Do not assume Sahul immediately integrates imported moas into warfare. Integration requires time, breeding continuation, and harness adaptation.
