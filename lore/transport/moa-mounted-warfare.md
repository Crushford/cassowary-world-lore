...
This document explains how moas function as imported mounts and transport animals in Cassowary World. It tracks import from New Zealand, spread across Sahul, and the use of moas in warfare and movement systems while distinguishing moa systems from Sahul-native giant goose mounted warfare.
...
- Related institutions: warfare, transport, breeding, imperial logistics
...
This is a system doc, not a divergence doc. The canon claim is that moas are used as mounts and transport animals; the unresolved part is only how ridability was achieved. Do not infer a new divergence from this file.

Moa mounted warfare develops in a world where some Sahul societies may already use domesticated giant geese as regional mounts. That does not make moas redundant. Giant goose mounted warfare depends on suitable local anseriform giant bird lineages, access to nesting grounds, established handlers, and terrain where those birds perform well. Moa systems enter Sahul through maritime exchange as already-managed New Zealand lineages with their own selection history.
