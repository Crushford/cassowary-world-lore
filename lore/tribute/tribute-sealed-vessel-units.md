...
This document answers how early cassowary tribute becomes measurable before weights, writing, or abstract accounting. It focuses on standardized sealed ceramic vessels as physical tribute units. Tribute jars are downstream of ant harvest and preservation; they are not the same as nest-assist pots used in living ant colonies.
...
Sealed vessel units convert preserved surplus into something an institution can demand, inspect, and compare. This lets early tribute work before scales, writing, or abstract equivalence systems exist.

This system depends on preservation and ceramic practice. The vessel is not just a container; it is the measurement unit. Once vessel form and fill convention become recognizable, tribute can be demanded as a count of physical objects rather than an abstract quantity.

These units feed directly into [Tribute Seal Integrity and Authority Marks](tribute-seal-integrity-and-authority-marks.md) because a counted vessel must also remain visibly sealed. They also feed into [Tribute Storage Custody and Redistribution](tribute-storage-custody-and-redistribution.md), where control over collected vessels becomes political power.
...
- [Tribute Storage Custody and Redistribution](tribute-storage-custody-and-redistribution.md)
