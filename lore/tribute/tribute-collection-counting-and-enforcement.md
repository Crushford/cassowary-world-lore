...
This system depends on [Tribute Sealed Vessel Units](tribute-sealed-vessel-units.md), [Tribute Seal Integrity and Authority Marks](tribute-seal-integrity-and-authority-marks.md), and [Tribute Storage Custody and Redistribution](tribute-storage-custody-and-redistribution.md). It also operates under the movement constraints summarized in [World State — Protohistoric Expansion Era](../../reference/world-state-protohistoric-expansion-era.md): poor routes, seasonal failures, fragmented productivity, and predator pressure keep collection local and episodic until stronger transport systems develop.
