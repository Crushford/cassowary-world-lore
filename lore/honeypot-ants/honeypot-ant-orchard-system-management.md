...
This document answers how cassowaries maintain the orchard, aphid, and honeypot ant relationships that make predictable sugar reserves possible. It focuses on the living production system that supports later harvesting and sugar preservation.

## Metadata

- Primary topic: honeypot ant orchard system management
- Layer: Cassowary World system
- Topics: honeypot ants, aphid stabilization, orchard management, ecological domestication, sugar production
