...
Purpose: Track canon status for technical systems documented in `technical-documents/`.
...
- Add every new technical document here when it is created.
- Update status here when a document is promoted or deprecated.
- This file tracks status only; mechanism details belong in the technical documents themselves.
